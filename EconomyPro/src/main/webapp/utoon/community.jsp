									...
									<c:forEach var="post" items="${list}" begin="0" end="2"
										...
										<div class="col-md-4 col-sm-4">
											<div class="box_main container">
												...
												<p class="community_text"><a href="#">${post.post_title}</a></p>
												<div class="btn_main">
													<div class="write_bt">
														<p> ${post.mem_id}</p>
													</div>
						...
						<div class="container">
							...
							<div class="fashion_section_2">
								<div class="row">
										...
										<c:forEach var="post" items="${list}" begin="3" end="5"
													step="1" varStatus="status"> 
											<div class="col-md-4 col-sm-4">
												<div class="box_main container">
													<h4 class="communitybox_text">${status.index+1}번째 글</h4>
						...
						<div class="container">
							...
							<div class="fashion_section_2">
								<div class="row">
										...
										<c:forEach var="post" items="${list}" begin="6" end="8"
													step="1" varStatus="status"> 
											<div class="col-md-4 col-sm-4">
												<div class="box_main container">
													<h4 class="communitybox_text">${status.index+1}번째 글</h4>
					...
					<div class="text-center">
						<div class="communitywrite">
							<a href="community_write.html"> <!-- <button type="button" class="btn_c_box">글쓰기</button></div> -->
								...
								role="button" data-slide="next"> <i class="fa fa-angle-left"></i>
							</a>
						</div>
					</div>
      ...
      <div class="container">
         <p class="copyright_text">© 2020 All Rights Reserved. Design by <a href="https://html.design">Free html
               Templates</a></p>
				...
				<!-- sidebar -->
				<script
					src="${cpath}/utoon/js/jquery.mCustomScrollbar.concat.min.js"></script>
